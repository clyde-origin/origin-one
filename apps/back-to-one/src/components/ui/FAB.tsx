      ...
      <div style={{ position: 'fixed', bottom: 68, left: '50%', transform: 'translateX(-50%)', width: 0, height: 0, zIndex: 30 }}>
        ...
        {!hideThreads && (
          <div className="flex items-center justify-center cursor-pointer relative"
            ...
            <svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M2.5 2h8a1 1 0 011 1v4.5a1 1 0 01-1 1H5l-2.5 2.5V3a1 1 0 011-1z" stroke="rgba(255,255,255,0.7)" strokeWidth="1.1" strokeLinejoin="round" /></svg>
          </div>
        )}
      </div>
    </>
